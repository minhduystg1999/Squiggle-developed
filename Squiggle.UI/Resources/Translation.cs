...
namespace Squiggle.UI.Resources
{
    class Translation
    {
        ...
        public string ChatWindow_Ignore { get; set; }
        public string ChatWindow_Unignore { get; set; }
        public string ChatWindow_Mute { get; set; }
        public string ChatWindow_Unmute { get; set; }
        ...
        public string ChatWindow_HasSentYouLike { get; set; }
        public string ChatWindow_YouSentLike { get; set; }
        public string ChatWindow_LikeError { get; set; }
        ...
        public string ChangeTitleDialog_Title { get; set; }
        public string ChangeTitleDialog_Label { get; set; }
